...
const SEED_POSTS: BlogPost[] = [
  {
    id: "post_001",
    slug: "como-a-tokenizacao-de-energia-funciona",
    title: "Como a tokenização de energia funciona na prática",
    excerpt:
      "Entenda em 4 minutos o modelo pelo qual investidores passam a participar economicamente de usinas solares sem os atritos tradicionais do setor.",
    content:
      "A tokenização de energia é um modelo em que frações econômicas de uma usina de geração são representadas por tokens digitais. O investidor passa a ter direito proporcional ao resultado da usina, com liquidação, rastreabilidade e consulta de posição em tempo real.\n\nNeste artigo da Byte7, cobrimos os três pilares do modelo: (1) o ativo subjacente — as usinas em operação; (2) a representação digital — o token que comprova a participação; (3) a camada de transparência — o portal do investidor, que é exatamente o que você está explorando nesta demo.\n\nNão há mágica financeira: o que existe é redução de atrito, rastreabilidade e um relacionamento mais direto entre quem gera energia e quem investe.",
    author: "Equipe Byte7",
    coverImage: "https://images.unsplash.com/photo-1509390157308-6a4f31e1a0a1?auto=format&fit=crop&w=1200&q=60",
    tags: ["tokenização", "energia", "educativo"],
    status: "published",
  ...
  },
  {
    ...
    excerpt:
      "Por que a Byte7 trata a consulta do investidor como uma peça central do produto — e não como uma obrigação de compliance.",
    content:
      "Investidor bem informado é investidor tranquilo. Essa frase parece óbvia, mas poucos players do mercado de energia tratam a camada de consulta como prioridade de produto.\n\nNa Byte7, o portal que você está navegando nesta demo é pensado com a mesma exigência técnica de um dashboard de fintech: KPIs consolidados, evolução mensal histórica, mapa das usinas vinculadas e o contrato acessível com um clique. Tudo isso apenas para consulta — não há qualquer movimentação financeira via portal, por desenho.\n\nQuando evoluirmos para a versão de produção, a arquitetura atual permite trocar a origem dos dados (mocks → API real) sem redesenhar a experiência.",
    author: "Equipe Byte7",
    coverImage: "https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=60",
    tags: ["transparência", "produto", "investidor"],
    status: "draft",
