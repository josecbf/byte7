...
export function EditorLoginForm() {
  ...
  const {
    ...
    defaultValues: { email: "editor@byte7.com.br", password: "editor123" }
  });

  const submit = handleSubmit(async (values) => {
    setServerError(null);
    try {
      await authService.loginEditor(values);
          ...
          <CardBody className="space-y-5">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-ink-500">
                Acesse para criar e editar posts do blog.
              </p>
            </div>
            ...
            <div className="rounded-md bg-ink-50 border border-ink-100 p-3 text-xs text-ink-600 space-y-1">
              ...
              <p><code>editor@byte7.com.br</code> · <code>editor123</code></p>
            </div>
